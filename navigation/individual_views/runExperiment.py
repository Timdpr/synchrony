...
test = TestPatternsOnNetwork([7, 90], 3, rotation=True, rot_step=30,
...
rsyncs[8][0] = rsync_test[0]
rsyncs[10][7] = rsync_test[1]

degrees[8] = degrees_test[0]
degrees[123] = degrees_test[1]
